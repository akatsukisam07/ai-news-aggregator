...
if __name__ == "__main__":
    ...
    transcript: Transcript = scraper.get_transcript("jqd6_bbjhS8")#transcript id
    print(transcript.text)
    channel_videos: List[ChannelVideo] = scraper.scrape_channel("UCn8ujwUInbJkBhffxqAPBVQ", hours=200)#chanel id and timeframe(within last 200 seconds recent)
